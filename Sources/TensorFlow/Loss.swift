...
public func meanAbsoluteError<Scalar: TensorFlowFloatingPoint>(
    ...
    l1Loss(predicted: predicted, expected: expected, reduction: _justTakesTheMean)
}
...
public func meanSquaredError<Scalar: TensorFlowFloatingPoint>(
    ...
    l2Loss(predicted: predicted, expected: expected, reduction: _justTakesTheMean)
}
...
public func meanSquaredLogarithmicError<Scalar: TensorFlowFloatingPoint>(
    ...
    return l2Loss(predicted: logPredicted, expected: logExpected, reduction: _justTakesTheMean)
}
...
public func hingeLoss<Scalar: TensorFlowFloatingPoint>(
    predicted: Tensor<Scalar>,
    expected: Tensor<Scalar>,
    reduction: @differentiable (Tensor<Scalar>) -> Tensor<Scalar> = _justTakesTheMean
) -> Tensor<Scalar> {
...
@differentiable
public func _justTakesTheMean<Scalar: TensorFlowFloatingPoint>(
